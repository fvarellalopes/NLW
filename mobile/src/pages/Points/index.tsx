...
const Points = () => {
  ...
  return (
    <SafeAreaView style={{
      ...
      <ScrollView horizontal style={{ flex: 1 }} showsHorizontalScrollIndicator={false} contentContainerStyle={{
        ...
        <View style={styles.itemsContainer}>
          {
            items.map(item => (
              ...
              >
                <SvgUri width={45} height={42} uri={item.image_url}></SvgUri>
